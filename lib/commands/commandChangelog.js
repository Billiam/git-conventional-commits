...
exports.builder = function (yargs) {
    ...
    yargs.option('markdown-prefix', {
        alias: 'p',
        type: 'string',
        array: true,
        desc: 'Prefix multiple custom markdown snippets e.g. "# Changelog',
        requiresArg: true
    })
}
...
exports.handler = async function (argv) {
    ...
    const fromTag = await commitConvention.getLastTag()
    ...
    let changelogMarkdown = changelogGenerator.generateMarkdown(commitLog, {
        ...
        customMarkdownPrefix: argv.markdownPrefix,
